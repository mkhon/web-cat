...
public class Messages extends NLS
{
    ...
    public static String APP_BEHAV_PREFERRED_RENDERER_TOOLTIP;
    public static String APP_BEHAV_SECTION_DESCRIPTION;
    public static String APP_BEHAV_SECTION_TITLE;
    public static String AUTHORS_ADD;
    public static String AUTHORS_AFFILIATION;
    public static String AUTHORS_EMAIL;
    public static String AUTHORS_ENTER_NAME_PROMPT;
    ...
    public static String COPYRIGHT_COPYRIGHT;
    public static String COPYRIGHT_GO;
    public static String COPYRIGHT_LICENSE;
    public static String COPYRIGHT_LICENSE_URL;
    public static String COPYRIGHT_SECTION_DESCRIPTION;
    public static String COPYRIGHT_SECTION_TITLE;
    ...
    public static String DATATYPE_DISPLAYNAME_BOOLEAN;
    public static String DATATYPE_DISPLAYNAME_DECIMAL;
    public static String DATATYPE_DISPLAYNAME_FLOAT;
    ...
    public static String EXPR_BUILDER_LIST;
    public static String EXPR_BUILDER_LIST_TOOLTIP;
    public static String EXPR_BUILDER_MAP;
    public static String EXPR_BUILDER_MAP_TOOLTIP;
    public static String EXPR_BUILDER_MATH;
    public static String EXPR_BUILDER_MATH_TOOLTIP;
    public static String EXPR_BUILDER_OGNL_TEMPLATES;
    public static String EXPR_BUILDER_SELECT_ALL;
    public static String EXPR_BUILDER_SELECT_ALL_TOOLTIP;
    public static String EXPR_BUILDER_SELECT_FIRST;
    public static String EXPR_BUILDER_SELECT_FIRST_TOOLTIP;
    public static String EXPR_BUILDER_SELECT_LAST;
    public static String EXPR_BUILDER_SELECT_LAST_TOOLTIP;
    public static String GENERAL_INFO_DESCRIPTION;
    public static String GENERAL_INFO_ERROR_EMPTY_DESCRIPTION;
    public static String GENERAL_INFO_ERROR_EMPTY_TITLE;
    public static String GENERAL_INFO_KEYWORDS;
    ...
    public static String PREVIEW_JOB_OBTAINING_DATA;
    public static String QUERY_BUILDER_DESCRIPTION;
    public static String QUERY_BUILDER_INSTRUCTION;
    public static String QUERY_BUILDER_TITLE;
    public static String QUERY_CLAUSE_AND;
    public static String QUERY_CLAUSE_THE_KEY_PATH;
    public static String QUERY_CLAUSE_THE_VALUE;
    public static String QUERY_COMPARISON_BETWEEN;
    public static String QUERY_COMPARISON_LIKE;
    public static String QUERY_COMPARISON_NOT_BETWEEN;
