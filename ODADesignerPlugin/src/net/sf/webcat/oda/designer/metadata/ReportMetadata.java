...
public class ReportMetadata
{
        ...
        if(_oldCount != null)
        {
            ...
            for (int i = 1; i <= oldCount; i++)
            {
                try
                {
                    ...
                    module.dropUserPropertyDefn(getAuthorProperty(
                            AUTHOR_EMAIL_PROP, i));
                    module.dropUserPropertyDefn(getAuthorProperty(AUTHOR_URL_PROP,
                            i));
                    module.dropUserPropertyDefn(getAuthorProperty(
     ...
     *            the report template handle
     * @param index
     *            the 1-based index of the author
    ...
    private static void updateBIRTAuthorProperty(ModuleHandle module)
    {
        ...
        if (count > 0)
        {
            String name = getAuthorName(module, 1);
