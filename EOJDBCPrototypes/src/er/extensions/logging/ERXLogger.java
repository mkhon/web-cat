...
public class ERXLogger extends org.apache.log4j.Logger {
	...
	public static synchronized void configureLogging(Properties properties) {
		...
		try
		{
		    // Temporarily install this class' class loader as the context
		    // loader, in case Log4j is actually being loaded in some
		    // parent loader where it won't be able to see ERX classes
		    Thread.currentThread().setContextClassLoader(
		        ERXLogger.class.getClassLoader());
