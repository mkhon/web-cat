    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
    ...
    //-- Local mutable cache --
    private net.sf.webcat.core.MutableArray batchedObjectIdsCache;
     ...
     */
    public net.sf.webcat.core.MutableArray batchedObjectIds()
    {
        NSData dbValue =
     ...
     */
    public void setBatchedObjectIds( net.sf.webcat.core.MutableArray value )
    {
