    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
    ...
    public static final ERXKey<net.sf.webcat.batchprocessor.BatchResult> batchResults =
        new ERXKey<net.sf.webcat.batchprocessor.BatchResult>(BATCH_RESULTS_KEY);
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.batchprocessor.BatchResult> batchResults()
    {
     ...
     * @param value The new set of entities to relate to
     */
    public void setBatchResults( NSMutableArray<net.sf.webcat.batchprocessor.BatchResult>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToBatchResults( net.sf.webcat.batchprocessor.BatchResult value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.batchprocessor.BatchResult> array =
            (NSMutableArray<net.sf.webcat.batchprocessor.BatchResult>)batchResults();
        willChange();
        array.addObject( value );
    }
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromBatchResults( net.sf.webcat.batchprocessor.BatchResult value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToBatchResultsRelationship( net.sf.webcat.batchprocessor.BatchResult value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromBatchResultsRelationship( net.sf.webcat.batchprocessor.BatchResult value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @return The new entity
     */
    public net.sf.webcat.batchprocessor.BatchResult createBatchResultsRelationship()
    {
        if (log.isDebugEnabled())
        {
        ...
        return (net.sf.webcat.batchprocessor.BatchResult)eoObject;
    }
     ...
     * @param value The entity to remove from the relationship and then delete
     */
    public void deleteBatchResultsRelationship( net.sf.webcat.batchprocessor.BatchResult value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllBatchResultsRelationships()
    {
        ...
        for (net.sf.webcat.batchprocessor.BatchResult object : batchResults())
        {
