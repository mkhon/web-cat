    ...
    extends er.extensions.eof.ERXGenericRecord
{
     ...
     * @return the value of the attribute
     */
    public net.sf.webcat.batchprocessor.BatchFeedbackLocation location()
    {
        String result =
            (String)storedValueForKey( "location" );
        return ( result == null )
            ? net.sf.webcat.batchprocessor.BatchFeedbackLocation.DEFAULT
            : net.sf.webcat.batchprocessor.BatchFeedbackLocation.valueOf(result);
    }
     ...
     * @param value The new value for this property
     */
    public void setLocation( net.sf.webcat.batchprocessor.BatchFeedbackLocation value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setLocation("
                + "net.sf.webcat.batchprocessor.BatchFeedbackLocation." + value
                + "): was net.sf.webcat.batchprocessor.BatchFeedbackLocation."
                + location().name() );
        }
     ...
     * @return the value of the attribute
     */
    public net.sf.webcat.batchprocessor.BatchFeedbackRecipient recipients()
    {
        String result =
            (String)storedValueForKey( "recipients" );
        return ( result == null )
            ? net.sf.webcat.batchprocessor.BatchFeedbackRecipient.OWNER
            : net.sf.webcat.batchprocessor.BatchFeedbackRecipient.valueOf(result);
    }
     ...
     * @param value The new value for this property
     */
    public void setRecipients( net.sf.webcat.batchprocessor.BatchFeedbackRecipient value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setRecipients("
                + "net.sf.webcat.batchprocessor.BatchFeedbackRecipient." + value
                + "): was net.sf.webcat.batchprocessor.BatchFeedbackRecipient."
                + recipients().name() );
        }
