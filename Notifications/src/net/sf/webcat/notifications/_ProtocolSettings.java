    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
        ...
        EOEditingContext ec, int id )
    {
        ...
        if (id > 0)
        {
            NSArray<ProtocolSettings> results =
    ...
    public static final ERXKey<net.sf.webcat.notifications.ProtocolSettings> parent =
        new ERXKey<net.sf.webcat.notifications.ProtocolSettings>(PARENT_KEY);
    public static final String USER_KEY = "user";
    public static final ERXKey<net.sf.webcat.core.User> user =
        new ERXKey<net.sf.webcat.core.User>(USER_KEY);
    // To-many relationships ---
    public static final String CHILDREN_KEY = "children";
    public static final ERXKey<net.sf.webcat.notifications.ProtocolSettings> children =
        new ERXKey<net.sf.webcat.notifications.ProtocolSettings>(CHILDREN_KEY);
    ...
    //-- Local mutable cache --
    private net.sf.webcat.core.MutableDictionary settingsCache;
     ...
     * @return the value of the attribute
     */
    public net.sf.webcat.core.MutableDictionary settings()
    {
        NSData dbValue =
     ...
     */
    public void setSettings( net.sf.webcat.core.MutableDictionary value )
    {
     ...
     */
    public net.sf.webcat.notifications.ProtocolSettings parent()
    {
        return (net.sf.webcat.notifications.ProtocolSettings)storedValueForKey( "parent" );
    }
     ...
     */
    public void setParent( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
            log.debug( "setParent("
        ...
        net.sf.webcat.notifications.ProtocolSettings value )
    {
        ...
        if ( value == null )
        {
            net.sf.webcat.notifications.ProtocolSettings object = parent();
            if ( object != null )
     ...
     */
    @SuppressWarnings("unchecked")
    public NSArray<net.sf.webcat.notifications.ProtocolSettings> children()
    {
     ...
     */
    public void setChildren( NSMutableArray<net.sf.webcat.notifications.ProtocolSettings>  value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToChildren( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
        ...
        NSMutableArray<net.sf.webcat.notifications.ProtocolSettings> array =
            (NSMutableArray<net.sf.webcat.notifications.ProtocolSettings>)children();
        willChange();
     ...
     */
    public void removeFromChildren( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The new entity to relate to
     */
    public void addToChildrenRelationship( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     * @param value The entity to remove from the relationship
     */
    public void removeFromChildrenRelationship( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
     ...
     */
    public net.sf.webcat.notifications.ProtocolSettings createChildrenRelationship()
    {
        if (log.isDebugEnabled())
        {
        ...
        addObjectToBothSidesOfRelationshipWithKey(
            eoObject, "children" );
        return (net.sf.webcat.notifications.ProtocolSettings)eoObject;
    }
     ...
     */
    public void deleteChildrenRelationship( net.sf.webcat.notifications.ProtocolSettings value )
    {
        if (log.isDebugEnabled())
        {
    ...
    public void deleteAllChildrenRelationships()
    {
        ...
        for (net.sf.webcat.notifications.ProtocolSettings object : children())
        {
        ...
        NSDictionary<String, Object> keysAndValues)
    {
        ...
        NSArray<ProtocolSettings> result =
