package Web_CAT::HTML::Entities;

# HTML::Entities::encode functions borrowed from HTML::Entities
# (that module isn't directly included here, since it depends on
# native lib support)

# Original HTML::Entities copyright:
