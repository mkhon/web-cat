/*==========================================================================*\
 |  $Id: FileBrowserDialog.java,v 1.1 2010/03/15 16:48:38 aallowat Exp $
 |*-------------------------------------------------------------------------*|
...
import net.sf.webcat.core.vfs.IDeletableFile;
import net.sf.webcat.core.vfs.IModifiableContainer;
import net.sf.webcat.core.vfs.IReadableFile;
import net.sf.webcat.core.vfs.IWritableFile;
import net.sf.webcat.core.vfs.WCFile;
import net.sf.webcat.core.vfs.WCRootedFolder;
import net.sf.webcat.ui.WCDialog;
 ...
 *
 * <dt>root</dt>
 * <dd>A {@link net.sf.webcat.core.vfs.WCFile} object representing the root of
 ...
 * @version $Id: FileBrowserDialog.java,v 1.1 2010/03/15 16:48:38 aallowat Exp $
 */
public class FileBrowserDialog extends WCComponent
{
    ...
    public void appendToResponse(WOResponse response, WOContext context)
    {
        ...
        String scriptDataRoot = net.sf.webcat.core.Application
