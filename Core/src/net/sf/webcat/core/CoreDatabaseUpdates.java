/*==========================================================================*\
 |  $Id: CoreDatabaseUpdates.java,v 1.1 2006/02/19 19:03:09 stedwar2 Exp $
 |*-------------------------------------------------------------------------*|
 ...
 * @version $Id: CoreDatabaseUpdates.java,v 1.1 2006/02/19 19:03:09 stedwar2 Exp $
 */
    ...
    extends UpdateSet
{
    ...
    private boolean finishInitializingDefaultDomain = false;
