...
// Generated by the WOLips Templateengine Plug-in at Sep 25, 2007 2:01:50 PM
...
public class AdvancedQueryAssistant extends ReporterComponent
{
	...
	public NSArray<String> keyPathCompletionItems()
	{
		...
		if(kpp.theClass() != null)
		{
			...
			return KVCAttributeFinder.attributesForClass(kpp.theClass(),
					prefix);
		}
		else
		{
    ...
    public NSArray<AdvancedQueryComparison> comparisonsForCurrentKeyPath()
    {
    	...
    	if(klass == Object.class)
    		return AdvancedQueryComparison.comparisonsForType(currentCastType());
    	else
