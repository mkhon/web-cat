    ...
    implements net.sf.webcat.core.MutableContainer.MutableContainerOwner
{
    ...
    public void deleteAllDataSetQueriesRelationships()
    {
        ...
        for (net.sf.webcat.reporter.ReportDataSetQuery object : dataSetQueries())
        {
     ...
     */
    public static ReportQuery firstObjectMatchingQualifier(
        EOEditingContext context,
        EOQualifier qualifier,
        NSArray<EOSortOrdering> sortOrderings)
    {
     ...
     */
    public static ReportQuery uniqueObjectMatchingQualifier(
        EOEditingContext context,
